...
import s6 from '../images/Cattle2.png';
...
const Project = () => {
    ...
    const slides = [
        { image: s6,name : "Cattle Behaviour Analysis" , link : "https://github.com/NakulanT/Cattle-behaviour-analysis",tools : "ReactJS, Python, Flask, OpenCV, Pytorch, Numpy, Pandas",description: "This advanced cattle behavior monitoring system leverages YOLOv8 deep learning models for real-time detection of behaviors (standing, lying, eating) and individual tracking via unique stickers, using a dual-model architecture with a real-time dashboard, offering scalable, cost-effective livestock management and future enhancements like mobile integration and predictive analytics." },
        ...
        { image: s3,name : "Med-Ecommerse Site",link : "https://github.com/NakulanT/Medical-shop",tools : "Yarn , ReactJs , MongoDB Atlas",description: "Crafted a responsive e-commerce medical platform using React and Node.js, delivering real-time product updates, Applied modern web development practices for an optimal online shopping experience.Successfully met client specifications on a freelance basis." },
